...
import example.imageviewer.services.PokemonService
...
abstract class Dependencies {
    ...
    val imageProvider: ImageProvider = object : ImageProvider {
        ...
        override fun edit(picture: PictureData, name: String, description: String): PictureData {
            when (picture) {
                ...
                else -> throw IllegalArgumentException("Unsupported PictureData type: ${picture::class.simpleName}")
            }
        }
    }

    fun generateRandomGpsPosition(): GpsPosition {
    ...
    init {
        ...
        GlobalScope.async {
            try {
                println(">>>>> Pokemons " + PokemonService().getAll())
